...
python -m main_lincls --trial $EXPERIMENT_NAME --seed 123 --arch resnet18 --num_cls 10 --batch_size 256 --lr 30.0 --weight_decay 0.0 --pretrained /work/dlclarge2/wagnerd-metassl_experiments/CIFAR10/800_run_same_param/800_run_same_param_best.pth "./data"
